...
/// </summary>
public class DragonArmyStartUp
{
    public static void Main()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            if (!int.TryParse(inputs[2], out int dragonDamage))
            {
                dragonDamage = 45;
            }

            if (!int.TryParse(inputs[3], out int dragonHealth))
            {
                dragonHealth = 250;
            }

            if (!int.TryParse(inputs[4], out int dragonArmour))
            {
                dragonArmour = 10;
            }
